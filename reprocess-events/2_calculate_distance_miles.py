...
def calc_distance(df):
    ...
    # For each row, calculate the distance in MILES  between "point" and "point_prev" and add it to a new "distance_miles" column
    ...
    # Cumulatively add up the values in the "distance_miles" and put the running totals in a new "distance_cumulative" column
